export class CenaJogo extends Phaser.Scene {
  ...
  create() {
    ...
    //indica a fase atual do jogo
    sessionStorage.setItem("faseAtual", "fase1");

    this.coinScoreAtual = 0;
    ...
    //pegando as coordenadas da pergunta dentro do tilemap
    const cordPergunta = map.findObject(
      "Pergunta",
      (objects) => objects.name === "cordPergunta"
    );

    this.add.sprite(cordPergunta.x, cordPergunta.y, "ex1");
