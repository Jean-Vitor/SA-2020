export class CenaJogo3 extends Phaser.Scene {
  constructor() {
    super({ key: "CenaJogo3" });
  }
  ...
  create() {
    ...
    //plataforma móvel
    this.movelPlataformaDireita = map.createStaticLayer(
      "movelplataformasDireita",
      tilesetMap,
      0,
      0
    );
    this.movelPlataformaEsquerda = map.createStaticLayer(
      "movelplataformasEsquerda",
      tilesetMap,
      0,
      0
    );
    const movelPlataformaDireita = this.movelPlataformaDireita;
    const movelPlataformaEsquerda = this.movelPlataformaEsquerda;

    this.tweens.add({
      targets: movelPlataformaDireita,
      x: "+=270",
      delay: 20,
      duration: 5000,
      yoyo: true,
    ...
    this.tweens.add({
      targets: movelPlataformaEsquerda,
      x: "-=270",
      delay: 20,
      duration: 5000,
      yoyo: true,
    ...
    movelPlataformaEsquerda.setCollisionByProperty({ collider: true });
    movelPlataformaDireita.setCollisionByProperty({ collider: true });

    this.physics.add.collider(this.player, movelPlataformaEsquerda, () => {
      this.naPlataforma = true;
    });

    this.physics.add.collider(this.player, movelPlataformaDireita, () => {
      this.naPlataforma = true;
    });
    ...
    this.add.sprite(cordPergunta.x, cordPergunta.y, "ex3");
